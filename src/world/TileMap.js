...
const OT_SOLID = new Set([OT.WATER, OT.TREE, OT.ROCK, OT.FENCE, OT.WALL, OT.QUESTBOARD, OT.SHOPCOUNTER]);

// Tuiles mine
export const MT = {
  WALL: 0, FLOOR: 1, ORE_COPPER: 2, ORE_IRON: 3, ORE_GOLD: 4, ORE_DIAMOND: 5,
  STAIRS: 6, STAIRS_SEALED: 7, ENTRANCE: 8,
};
const MT_SOLID = new Set([MT.WALL, MT.ORE_COPPER, MT.ORE_IRON, MT.ORE_GOLD, MT.ORE_DIAMOND, MT.STAIRS_SEALED]);
